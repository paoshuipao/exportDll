...
namespace PSPUtil 
{
	...
	public class PropsConfigData : IConfig 
	{
		...
		{
			return "     道具ID- "+id+"     道具名- "+name+"     道具等级- "+level+"     道具类型- "+propsType+"     绑金币- "+goldCoin+"     晶石- "+JingShi+"     图标所在图集- "+sheet+"     图标ID- "+icon+"     额外配置数据- "+UserData+"     掉落模型- "+dropIcon+"     最大堆叠量- "+maxAmount+"     是否可直接使用- "+canUse+"     使用道具触发buff- "+triggerBuffId+"     道具描述- "+description+"     攻击- "+attack+"     防御- "+defense+"     低级合成概率- "+rate;
		}
