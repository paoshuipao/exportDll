...
namespace PSPUtil 
{
	...
	public class EquipConfigData : IConfig 
	{
		...
		{
			return "     装备ID- "+id+"     装备名称- "+name+"     图标所在图集- "+sheet+"     图标ID- "+icon+"     模型ID- "+modelId+"     掉落模型- "+dropIcon+"     职业类型- "+job+"     武器是否有刀鞘- "+hasScabbard+"     使用等级- "+useLevel+"     是否时装- "+isFashion+"     装备等级- "+equipLevel+"     装备部位- "+equipPosition+"     出售系统价格- "+goldCost+"     攻击- "+attack+"     防御- "+defense+"     装备描述- "+description+"     攻击- "+randAttack+"     防御- "+randDefense;
		}
