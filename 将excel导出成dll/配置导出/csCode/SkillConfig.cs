...
namespace PSPUtil 
{
	...
	public class SkillConfigData : IConfig 
	{
		...
		{
			return "     主键ID- "+id+"     技能名称- "+name+"     职业- "+job+"     技能图标所在sheet- "+sheet+"     技能图标名称- "+icon+"     技能表现模版- "+template+"     技能播放动画- "+animationName+"     攻击动画时间(毫秒)- "+animationTime+"     技能描述- "+introduce+"     技能释放音效- "+effectSound+"     击中音效- "+hitSound;
		}
